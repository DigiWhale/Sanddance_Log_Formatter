...
def plot_coordinates_on_mapbox(df, save_path):
  ...
  try:
    ...
    fig6 = px.scatter_mapbox(df, lat="annomaly_gps_lat", lon="annomaly_gps_lon", size='gps_minus_rpi_bearing', color_continuous_scale=px.colors.cyclical.IceFire, size_max=15, zoom=10)
    fig7 = px.scatter_mapbox(df, lat="annomaly_rpi_lat", lon="annomaly_rpi_lon", size='gps_minus_rpi_bearing', color_continuous_scale=px.colors.cyclical.IceFire, size_max=15, zoom=10)
